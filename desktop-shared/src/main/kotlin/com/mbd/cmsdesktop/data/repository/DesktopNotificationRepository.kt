...
class DesktopNotificationRepository @Inject constructor(
    ...
    override fun observeUnreadCount(role: NotificationTargetRole, context: NotificationAudienceContext): Flow<Int> =
        viewStateDao.observeLastViewedAt().map { it ?: 0L }.distinctUntilChanged().flatMapLatest { since ->
    ...
    override suspend fun send(title: String, body: String, targetRole: NotificationTargetRole, targetOfferingId: String?, createdByUid: String, priority: NotificationPriority, targetDeptId: String?, expiresAt: Instant?) {
