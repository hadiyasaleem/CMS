...
class NotificationsBadgeViewModel @Inject constructor(
    ...
    val unreadCount = repository.observeUnreadCount(NotificationTargetRole.ADMIN)
        .stateIn(viewModelScope, SharingStarted.WhileSubscribed(5_000), 0)

    init {
        viewModelScope.launch { runCatching { repository.sync(NotificationTargetRole.ADMIN) } }
    }
}
