...
@Composable
fun StudentScaffold(onSignedOut: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            CmsTopBar(
                ...
                onNotifications = {
                    navController.navigate(StudentDestination.Notifications.route) { launchSingleTop = true }
                },
        ...
        bottomBar = {
            NavigationBar(
                ...
                StudentDestination.bottomNavItems.forEach { destination ->
                    NavigationBarItem(
                        selected = currentRoute == destination.route,
                        onClick = {
                            navController.navigate(destination.route) {
                                popUpTo(StudentDestination.Home.route) { saveState = true }
